...
namespace HK
{
    ...
    {
        public static List<Tercero> Buscar(string Texto, string Tipo)
        {
        ...
        public static List<Tercero> Buscar(string Texto)
        {
            using (var dc =new Entities())
            {
                var Consulta = from p in dc.Terceros
                               where (p.CedulaRif.Contains( Texto) || p.RazonSocial.Contains(Texto)) && (p.Activo == true) && p.Tipo =="PROVEEDOR"
                               orderby p.RazonSocial
                               select p;
                return Consulta.ToList();
            }
        }
        public static List<Tercero> Buscar(Entities dc, string Texto, string Tipo)
        {
                var Consulta = from p in dc.Terceros
                               where (p.CedulaRif.Contains( Texto )|| p.RazonSocial.Contains(Texto)) && (p.Tipo == Tipo) && (p.Activo == true)
                               orderby p.RazonSocial
        ...
        public static List<Tercero> Buscar(Entities dc, string Texto)
        {
        ...
        public static bool VerificarDuplicidad(string _idtercero,string _cedula, string _razonsocial)
        {
            ...
            //{
            //    {
            //        Tercero Tercero = dc.Terceros.FirstOrDefault(x => x.CedulaRif == _cedula);
            //        if (Tercero != null)
            //        {
        ...
        public static bool VerificarIntegridad(string Id)
        {
            using (var dc =new Entities())
            {
                Documento Doc = dc.Documentos.FirstOrDefault(x => x.IdTercero == Id);
                return (Doc != null);
            }
        }
        public static bool Delete( string Id )
        {
            using (var dc =new Entities())
            {
                Tercero Item = dc.Terceros.FirstOrDefault(x => x.IdTercero == Id);
                if (Item == null)
                    return false;
        ...
        public static Tercero Item(string IdTercero)      
        {
            using (var dc =new Entities())
            {
        ...
        public static Tercero ItemxCedula(string Cedula)
        {
            using (var dc =new Entities())
            {
        ...
        public static Tercero ItemxNombre(string Nombre)
        {
            using (var dc =new Entities())
            {
        ...
        public static bool Guardar(Tercero Tercero)
        {
           using (var dc =new Entities())
            {
        ...
        public static List<Tercero> ItemsxTipo(string Tipo)
        {
            using (var dc =new Entities())
            {
                var q = (from p in dc.Terceros
