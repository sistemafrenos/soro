...
namespace HK
{
    public partial class FrmPedidosProveedor : Form
    {
        ...
        {
            Documentos = FactoryDocumentos.Buscar(new Entities(), this.txtBuscar.Text, "PEDIDO PROVEEDOR", true);
        ...
        {
            Documento Item = (Documento)bs.Current;
            if (Item == null)
            {
                return;
            }
            ...
            {
                Documento Documento = FactoryDocumentos.Item(dc, Item.IdDocumento);
